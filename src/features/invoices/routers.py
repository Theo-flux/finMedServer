...
@invoice_router.get(
    "", status_code=200, response_model=ServerRespModel[PaginatedResponseModel[SingleInvoiceResponseModel]]
)
...
@invoice_router.get(
    "/{invoice_uid}/payments", response_model=ServerRespModel[PaginatedResponseModel[SinglePaymentResponseModel]]
)
